...
export class Joystick {
  ...
  private setupEventListeners(): void {
    ...
    joystick.addEventListener('pointerdown', this.onPointerDown.bind(this));
    joystick.addEventListener('pointermove', this.onPointerMove.bind(this));
    joystick.addEventListener('pointerup', this.onPointerUp.bind(this));
    joystick.addEventListener('pointercancel', this.onPointerUp.bind(this));
